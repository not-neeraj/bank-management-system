...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree (String formno) {
        ...
        JLabel number = new JLabel ("XXXX-XXXX-XXXX-3204");
        ...
        c7 = new JCheckBox("I hereby declare that the above entered details entered are correct are correct to the best of my knowledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource()==submit){
            ...
            try{
                 if(accounttype.equals("") && checkbox.equals("")){
                    JOptionPane.showMessageDialog(null, "Account type is required and Checkox must be declared");
                }
                 else{
                    Conn conn = new Conn();
